...
enum PropertyID
{
    ...
    PID_CUSTOM_RESERVED_TUNNELS_CTRL = 200, // custom propertiy to control the stacks behaviour for reserverd tunnels, not in Spec (PID >= 200)
    PID_CUSTOM_RESERVED_TUNNELS_IP = 201, // custom propertiy to control the stacks behaviour for reserverd tunnels, not in Spec (PID >= 200)

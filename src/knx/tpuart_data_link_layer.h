...
// #endif
  ...
  private:
    ...
    // void processRxFrame(TpFrame* tpFrame);
    // void rxFrameReceived(TpFrame* tpFrame);
    // void processRxFrameByte(uint8_t byte);
    ...
    // bool processTxFrameBytes();
    // bool sendFrame(CemiFrame& frame);
    // void dataConBytesReceived(uint8_t* buffer, uint16_t length, bool success);
    // void connected(bool state = true);
    // void isrUnlock();
    // bool isrLock(bool blocking = false);
    ...
    // bool processTxFrameBytes();
    // bool sendFrame(CemiFrame& frame);
    // void dataConBytesReceived(uint8_t* buffer, uint16_t
#ifdef ARDUINO_ARCH_ESP32
